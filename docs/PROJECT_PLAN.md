...
| B‑2    | Mass‑blast Wizard         | Compose bulk DM, optionally schedule, track opens & sales.                                                                                                             | Wizard stores campaign, queue fires messages, stats update hourly. Scheduled sends can be cleared via PUT /api/ppv/:id with scheduleDay and scheduleTime null.                   | cron/processOutbox.js               | POST /mass-messaging, GET /mass-messaging/{id}                                                                                                                                        | GPT optional subject-line suggestions              |
